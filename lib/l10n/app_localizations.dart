...
abstract class AppLocalizations {
  ...
  /// No description provided for @cellAlreadyOccupied.
  ///
  /// In en, this message translates to:
  /// **'Cell already occupied'**
  String get cellAlreadyOccupied;

  /// No description provided for @gameNotInProgress.
  ///
  /// In en, this message translates to:
  /// **'Game is not in progress'**
  String get gameNotInProgress;
